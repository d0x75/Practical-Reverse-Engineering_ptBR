...
Tipos de dados, e suas nomeclaturas mais cumuns :
		...
		tratá-los como valores de 64 bits em alguns cenários.

_Exemplo_: Usando a instrução [RDTSC](https://docs.microsoft.com/pt-br/cpp/intrinsics/rdtsc?view=msvc-160) é possível gravar um valor de 64 bits em EDX:EAX
