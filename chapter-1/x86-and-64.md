...
- As instruções operam com valores que vem de registradores ou da memória principal. A instrução mais comum para mover dados é a instrução *MOV*. Um uso bem simples é mover um registrador ou um imediato para um registrador.
Exemplo :
