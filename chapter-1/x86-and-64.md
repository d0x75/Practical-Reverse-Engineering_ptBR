...
offset pode ser um registrador ou um operadando imediato. Essa forma é comumente usado para acessar
itens das structs ou buffers de dados em um local calculado em tempo de execução.Por exemplo,suponha
que *ECX* aponte para uma estrutura do tipo KDPC com o layout :
