...
![Imgur](https://i.imgur.com/umsHMLQ.png)

O campo "Type" é definido como 0x13 (bits em negrito), "Importance" é definido como 0x1 (bits sublinhados) e Number é definido como 0x0
...
No exemplo, os bytes do prefixo de substituição são C6 e 66 (em itálico). Outros prefixos são discutidos à medida que aparecem.
...
Isso é melhor compreendido por meio de exemplos e prática:
		...
		; normalemente escrito como:  mov esi, [_KdLogBuffer + esi * 4]
...
provavelmente uma struct que tem um array no offset "+4". A linha 7 incrementa o Index. A linha 8 compara o Index com o offset +0 da
mesma struct.
