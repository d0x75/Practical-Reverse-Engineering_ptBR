...
Além disso, eles também atualizam automaticamente o endereço de DESTINO/ORIGEM dependendo do sinalizador de direção (DF) flag de EFLAGS
...
implementar funções de String ou funções de copiar Memória quando o comprimento/largura é conhecido em tempo de compilação. Em alguns
casos são acompanhados pelo prefixo "RET", que repete uma instrução até **ECX** vezes. Considere o seguinte exemplo :
